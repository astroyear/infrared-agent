...
from ultralytics.nn.extra_modules.block import Fused_Fourier_Conv_Mixer, RepNCSP, MutilScaleEdgeInformationSelect, Conv3XCNCSP
...
class Conv3XCNCSPELAN4_v2(nn.Module):
     # csp-elan
    def __init__(self, c1, c2, c3, c4, c5=1):  # ch_in, ch_out, number, shortcut, groups, expansion
        super().__init__()
        self.c = c3 // 2
